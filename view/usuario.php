...
<head>
    ...
    <script>
        ...
        function seleccionar(codigo, username, password, nivel) {
            document.getElementById("txtUsername").value = nombre;
            document.getElementById("txtPassword").value = apellido;
            document.getElementById("txtNivel").value = nit;
        }
            ...
            <div class="modal-content">
                ...
                <form id="form1">
                    <div class="modal-body">
                        <input type="text" id="txtUsername" name="txtUsername" placeholder="Username" required class="form-control">
                        <input type="password" id="txtPassword" name="txtPassword" placeholder="Password" required class="form-control">
                        <input type="text" id="txtNivel" name="txtNivel" placeholder="Nivel" required class="form-control">
