            ...
            <div class="modal-content">
                ...
                <form id="form1">
                    <div class="modal-body">
                        <input type="text" id="txtPlaca" name="txtPlaca" placeholder="Placa" required class="form-control">
                        <input type="text" id="txtMarca" name="txtMarca" placeholder="Marca" required class="form-control">
                        <input type="text" id="txtModelo" name="txtModelo" placeholder="Modelo" required class="form-control">
                        <input type="text" id="txtAnioFabricacion" name="txtAnioFabricacion" placeholder="Año de fabricacion" required class="form-control">
                        <input type="text" id="txtKilometraje" name="txtKilometraje" placeholder="Kilometraje" required class="form-control">
                        <input type="text" id="txtDisponibilidad" name="txtDisponibilidad" placeholder="Disponibilidad" required class="form-control">
                        </select>
                    </div>
